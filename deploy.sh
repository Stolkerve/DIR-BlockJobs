...
near call $MA add_token '{"token": "dai.fakes.testnet"}' --accountId $MA
...
near call $MA mint_service '{"metadata": {"title": "Desarrollo web", "description": "Trabajo part-time con React", "icon": "foto.png", "price": 1, "categories": "none", "token": "dai.fakes.testnet"}, "quantity": 1, "duration": 30}' --accountId $ID --amount 0.029
