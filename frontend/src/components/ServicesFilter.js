    ...
    return (
        <div className="sticky top-4 border-2 shadow-md borde rounded-lg px-6 py-4 mt-4 mr-6 w-[260px] w-max-[260px] max-h-[400px] overflow-y-scroll">
            ...
            <div className="mx-1">
                ...
                <input className="!w-max-[148px] px-2 !w-[148px] rounded outline-2 outline outline-[#27C0EF] bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700" type={"number"} />
            </div>
            ...
            <div className="mx-1">
                ...
                <input className="!w-max-[148px] !w-[148px] rounded px-2 outline-2 outline outline-[#27C0EF] bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700" type={"number"} />
            </div>
