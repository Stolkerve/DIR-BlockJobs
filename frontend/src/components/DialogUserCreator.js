                                ...
                                idiomInput.map((v, index) => {
                                    return (
                                        <div className="flex items-center self-stretch w-full mb-2" key={index}>
                                            <Select className="bg-gray-200 w-full mr-2" placeholder="Idioma" options={idiomsData} defaultInputValue={v.idiom} value={{ value: v.idiom, label: v.idiom }} controlShouldRenderValue={true} onChange={(value) => {
