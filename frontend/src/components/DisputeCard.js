                    ...
                    <div className="min-h-screen px-4 text-center">
                        ...
                        >
                            <div className="w-auto inline-block max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                                ...
                                <div className="mt-4">
                                    <button onClick={ async () => {await updateDisputeStatus(dispute.id)}} className="inline-flex justify-center items-center px-4 py-2 mr-4 text-white bg-[#27C0EF] border border-transparent rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 font-bold">Ok</button>
                                    <button onClick={closeModal} className="inline-flex justify-center items-center px-4 py-2 mr-4 text-white bg-red-600 border border-transparent rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 font-bold">No</button>
                                </div>
                            </div>
                        </Transition.Child>
                    </div>
